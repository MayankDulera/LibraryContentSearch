...
<!-- Editable table -->
<div class="card">
    <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Institute table</h3>
    <div class="card-body">
      <div id="table" class="table-editable">
        <span class="table-add float-right mb-3 mr-2"><a href="InsertInstitue.php" name="insertinstitute" class="text-success">
        <i class="fas fa-plus fa-2x" aria-hidden="true"></i></a></span>
        <table class="table table-bordered table-responsive-md table-striped text-center">
          <thead>
            <tr>
              <th class="text-center">Institute ID</th>
          ...
          ?>
              <td class="pt-3-half" contenteditable="false"><?php echo $Institute_ID; ?></td>
              <td class="pt-3-half" contenteditable="false"><?php echo $Name; ?></td>
              <td class="pt-3-half">

                <span class="table-down"><a type="button" href="updateInstitute.php?updateInstitute=<?php echo $Institute_ID; ?>" name="updateAuthor" class="indigo-text"><i class="far fa-edit" style="color:green;"></i></a></span>
              </td>
              <td>
                <span class="table-remove"><a type="button" href="delete_Institute.php?delete_Institute=<?php echo $Institute_ID; ?>" name="remove"
