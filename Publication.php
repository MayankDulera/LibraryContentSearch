...
<li class="nav-item active">
                    ...
                    <li class="nav-item active">
                      <a class="nav-link" href="Author">Author
...
<!-- Editable table -->
<div class="card">
    <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Publication table</h3>
    <div class="card-body">
      <div id="table" class="table-editable">
        <span class="table-add float-right mb-3 mr-2"><a href="InsertPublication.php" name="insertauthor" class="text-success">
        <i class="fas fa-plus fa-2x" aria-hidden="true"></i></a></span>
        <table class="table table-bordered table-responsive-md table-striped text-center">
          <thead>
            <tr>
              <th class="text-center">Publication_ID</th>
          ...
          ?>
              <td class="pt-3-half" contenteditable="false"><?php echo $Publication_ID; ?></td>
              ...
              <td>
                <span class="table-remove"><a type="button" href="delete_publication.php?delete_publication=<?php echo $Publication_ID; ?>" name="remove"
...
<div class="footer" style="padding-top:72px;"  style="height: 100px;">
