...
<div class="card">
    ...
    <div class="card-body px-lg-5 pt-0">
      ...
      <form class="text-center"  style="color: #757575;" method="post">
        ...
        <!-- Email -->
        <div class="md-form">
          <input type="text" name="Publication" id="UserEmail" class="form-control">
          <label for="Publication">Publication Name</label>
        </div>
        <button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" name="insertPublication" style="border-radius: 100px;" type="submit">Insert</button>
      </form>
    </div>
  </div>
</div>
<div class="footer" style="padding-top:198px;"  style="height: 100px;">
...
<?php
  if(isset($_POST['insertPublication']))
  {
    $Publication = $_POST['Publication'];
    $insert_publi = "insert into publication(P_Name) value('$Publication')";
    $run_publi = mysqli_query($con,$insert_publi);
    $_SESSION['Publication_ID']=$Publication_ID;
      echo "<script>alert('Publication Inserted')</script>";
