...
<div class="card" style="width:auto;">
    <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Article table
      ...
      <span class="table-add float-right mb-3 mr-2">
        ...
        <table class="table table-bordered table-responsive-md table-striped text-center">
          ...
          ?>
              ...
              <td class="pt-3-half" contenteditable="false"><?php echo " <img src='$Image' width='200' height='auto'/> "; ?></td>  
...
<div class="footer" style="padding-top:118px;"  style="height: 100px;width: 1535px;">
