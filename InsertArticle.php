...
<div class="card">
    ...
    <div class="card-body px-lg-5 pt-0">
      ...
      <form class="text-center"  style="color: #757575;" method="post">
        ...
        <!-- Email -->
        <div class="md-form">
          <input type="text" name="Article_name" id="UserEmail" class="form-control">
          <label for="Article_name">Article Name</label>
          <input placeholder="Selected date" type="date" name="adate" class="form-control datepicker"/>
        </div>
  ...
  <div class="custom-file" >
    <input type="file" class="custom-file-input" name="Article_Image" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" >
...
<select class="custom-select custom-select-sm" name="Institute_name">
  ...
  <?php 
          include("includes/db.php");
            ...
            while($row_institute=mysqli_fetch_array($run_institute)){
              ...
              $Name = $row_institute['I_Name'];
              echo  "<option value='$Institute_id'>$Name</option>";
...
<div class="form-group">
  <textarea class="form-control rounded-0" name="wcontent" id="exampleFormControlTextarea2" placeholder="Write content here.." rows="3"></textarea>
</div>
<div class="md-form">
        ...
        <button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" name="insertArticle" style="border-radius: 100px;" type="submit">Insert</button>
      </form>
    </div>
  </div>
</div>
...
<?php 
  if(isset($_POST['insertArticle']))
  {
    ...
    $img = file_get_contents($Article_Image);
    ...
    $temp_Image_name = $_FILES['Article_Image']['temp_Image_name'];

    move_uploaded_file($temp_Image_name,"images/$img");
    $insert_article = "insert into article(name,date,Author_ID,Publication_ID,image,Content,Page_no,M_ID,keywords,Institute_id) values('$Article_name','$date','$Author_name','$Publication_name','$img','$wcontent','$Page_no','$Magazine_name','$keywords','$Institute_name')";
    $run_user=mysqli_query($con,$insert_article) or die("Error: ".mysqli_error($con));
     
      $_SESSION['article_id']=$article_id;
      echo "<script>alert('Article Inserted Successfilly')</script>";
