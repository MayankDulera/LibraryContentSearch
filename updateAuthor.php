...
<div class="card">
    ...
    <div class="card-body px-lg-5 pt-0">
      ...
      <form class="text-center"  style="color: #757575;" method="post">
        ...
        <!-- Email -->
        <div class="md-form">
          <input type="text" name="Author" id="UserEmail" value="<?php echo $Name; ?>" class="form-control">
          <label for="Author">Author Name</label>
        </div>
        <button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" name="updateAuthor" style="border-radius: 100px;" type="submit">Update</button>
      </form>
    </div>
  </div>
</div>
