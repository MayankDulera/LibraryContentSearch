    ...
    <div class="card-body">
      <div id="table" class="table-editable">
        ...
        <table class="table table-bordered table-responsive-md table-striped text-center">
          ...
          ?>
              <td class="pt-3-half" contenteditable="false"><?php echo $Author_ID; ?></td>
              <td class="pt-3-half" contenteditable="false"><?php echo $Name; ?></td>
              <td class="pt-3-half">

                <span class="table-down"><a type="button" href="updateAuthor.php?updateAuthor=<?php echo $Author_ID; ?>" name="updateAuthor" class="indigo-text"><i class="far fa-edit" style="color:green;"></i></a></span>
              </td>
              <td>
                <span class="table-remove"><a type="button" href="delete_auth.php?delete_auth=<?php echo $Author_ID; ?>" name="remove"
