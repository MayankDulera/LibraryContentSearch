...
<div class="header" style="height: 100px;width: 1500px;">
  <div class="row">
    <div class="col-md-12"><!--Navbar-->
        <nav class="navbar navbar-expand-lg navbar-dark primary-color navbar" style="height: 100px;width: 1519px;position:absolute;">
          <!-- Collapse button -->
          ...
          <div class="collapse navbar-collapse" id="basicExampleNav">
            ...
            <ul class="navbar-nav mr-auto my-2 my-lg-0 ml-auto " style="padding-left: 850px;">
...
<div class="footer" style="padding-top:500px;position:relative;height: 100px;width: 1519px;">
