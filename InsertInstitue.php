...
<div class="card">
    ...
    <h5 class="card-header white-text text-center py-4" style="background-color: #4285F4;">
      <strong>Insert Institute</strong>
    </h5>
    ...
    <div class="card-body px-lg-5 pt-0">
      ...
      <form class="text-center"  style="color: #757575;" method="post">
        ...
        <!-- Email -->
        <div class="md-form">
          <input type="text" name="institute" id="UserEmail" class="form-control">
          <label for="institute">Institute Name</label>
        </div>
        <button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" name="insertinstitute" style="border-radius: 100px;" type="submit">Insert</button>
      </form>
    </div>
  </div>
</div>
...
<?php
  if(isset($_POST['insertinstitute']))
  {
    $institute = $_POST['institute'];
    $insert_institute = "insert into institute(I_Name) value('$institute')";
    $run_institute = mysqli_query($con,$insert_institute);
    $_SESSION['Institute_ID']=$Institute_ID;
      echo "<script>alert('Institute Inserted')</script>";
